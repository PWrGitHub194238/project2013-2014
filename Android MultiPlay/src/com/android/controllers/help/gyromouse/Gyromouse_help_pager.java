...
public class Gyromouse_help_pager extends FragmentPagerAdapter {
	...
	private final int[] PAGE_TITLES = {
			R.string.help_gyromouse_page_title_1,
			R.string.help_gyromouse_page_title_2
	};
	 ...
	 * @param resources
	 */
	public Gyromouse_help_pager(FragmentManager fragmentManager, Resources resources) {
