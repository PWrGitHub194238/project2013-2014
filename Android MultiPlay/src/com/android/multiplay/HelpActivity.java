...
public class HelpActivity extends Activity implements DialogButtonClickListener {
	 ...
	 * Menu button.
	 * 
	 * It leaves to next activity: {@link MultiplayExplorerHelpActivity}. This
	 * button is not active if no wireless or bluetooth connections were found.
	 ...
	 * Menu button.
	 * 
	 * It leaves to next activity: {@link SystemControllerHelpActivity}. This
	 * button is not active if no wireless or bluetooth connections were found.
	 * On click it call method {@link #connections_OnClick(View)}.
	 */
	 ...
	 * Menu button.
	 * 
	 * It leaves to next activity: {@link OptionsHelpActivity}. This button is
	 * not active if no wireless or bluetooth connections were found. On click
	 * it call method {@link #connections_OnClick(View)}.
	 */
	...
	/**
	 * Default initial method that constrains all tasks that should be done
	 * either {{@link #onCreate(Bundle)} or {{@link #onRestart()}. It requests
	 * back focus to unfocused any menu items.
	 */
	private void init() {
	...
	/**
	 * Initialize method that links {@link #b_explorer} object with correct View
	 * by id.
	 * 
	 * Also creates a new listener for this button's events by passing this
	 * {@link Activity} and id parameter to
	 * {@link ButtonsFocusChangeListener#ButtonsFocusChangeListener(Activity, int)}
	 * .
	 * 
	 * @param id
	 *            ID of view in {@link com.android.multiplay.R}
	 */
	private void initB_explorer(int id) {
		this.b_explorer = (ImageButton) super.findViewById(id);
		this.b_explorer
				.setOnFocusChangeListener(new ButtonsFocusChangeListener(this,
						id));
	}

	/**
	 * Initialize method that links {@link #b_controllers} object with correct
	 * View by id.
	 * 
	 * Also creates a new listener for this button's events by passing this
	 * {@link Activity} and id parameter to
	...
	/**
	 * Initialize method that links {@link #b_options} object with correct View
	 * by id.
	 * 
	 * Also creates a new listener for this button's events by passing this
	 * {@link Activity} and id parameter to
	...
	private void initB_options(int id) {
		...
		this.b_options.setOnFocusChangeListener(new ButtonsFocusChangeListener(
				this, id));
	}

	private void initB_goback(int id) {
		this.b_goback = (ImageButton) super.findViewById(id);
		this.b_goback.setOnFocusChangeListener(new ButtonsFocusChangeListener(
				this, id));
	}

	// //////////////////DialogButtonClickListener's methods for dialog
	// interaction
