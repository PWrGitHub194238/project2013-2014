 ...
 * 
 * <ul>
 * 	<li>The first five, the least significant, bits ("I" bits) define the type (ID) of controller, 
 * which signal is sent (the list of controllers is listed here: {@link Device}).</li>
 * 	<li>Bit "C" keeps track of the amount of data sent by the controller in the signal:
 * 	<ul>
 * 		<li>0 - signal includes a single chunk of data, the remaining 12 bits of a signal ("D" bits) is empty 
 * and will not be taken into account. The list of available  controller signals are listed here: {@link DeviceSignal}.</li>
 * 		<li>1 - Signal is full and in most common it holds a pair of coordinates; X 
 * on the 12 more significant bits ("d" bits) and Y on the remaining 12 ("D" bits).</li>
 * 	</ul>
 * 	<li>24 bits are allocated for storing data generated by the controller. 
 * They consist of  either pair of 12 bits that storing coordinates X and Y (in most common on "d" bits and "D" bits) 
 * or single signal stored at 12, more significant, bits ("d" bits).</li>
...
public final class N {
    ...
    public static final class DeviceSignal {
        ...
        public static final int KEYBOARD_LEFT = 			Integer.parseInt("000000000000", 2);
        public static final int KEYBOARD_RIGHT = 			Integer.parseInt("000000000001", 2);
        public static final int KEYBOARD_DOWN = 			Integer.parseInt("000000000010", 2);
        public static final int KEYBOARD_UP = 				Integer.parseInt("000000000011",2);
        public static final int KEYBOARD_SHIFT = 			Integer.parseInt("000000000100", 2);
        public static final int KEYBOARD_ENTER = 			Integer.parseInt("000000000101", 2);
        public static final int KEYBOARD_ESC = 				Integer.parseInt("000000011011", 2);
        public static final int KEYBOARD_SPACE = 			Integer.parseInt("000000100000", 2);
        public static final int KEYBOARD_CONTROL = 			Integer.parseInt("000000000110", 2);
        public static final int KEYBOARD_BACKSPACE = 		Integer.parseInt("000000000111", 2);
    ...
    public static final class Helper {
    	 ...
    	 * 
    	 */
    	public static final int encodeSignal(int device, int dev_data_counter, int dev_signal_1) {
    		return device 
