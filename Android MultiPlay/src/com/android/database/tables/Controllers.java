 ...
 * 	newValues.put(Controllers.DBSchema.COLUMN_1, "Name");
 * 	newValues.put(Controllers.DBSchema.COLUMN_2, DBHelper.CONTROLLER_TYPE_MOUSE);
 * Controllers.SQL_UPDATE_ROW(1, newValues);
 * }
 *
 * 
 ...
 * @author tomasz
 */
public class Controllers implements DBHelper.TableIF {

	/** Inner class for {@link Controllers} that implements {@link BaseColumns}.
	 * 
	...
	public static abstract class DBSchema implements BaseColumns {
        ...
        public static final String KEY_UNIQUE_1 = "ControllersID";
	}
	...
	/** Generates String that contains query to database for creating Controllers table.
	 * 
	 */
	...
	/** Generates String that contains query to database for deleting Controllers table.
	 * 
	 */
