...
/** Displays the alert dialog box that contains {@link ScrollView}. It shows 1st welcome screen to new user.
 * 
 * @author tomasz
 *
 */
public class WelcomeDialogCheckRequirements_1Step extends ScrollViewDialog implements OnProgressChangedListener, EditText.OnEditorActionListener {
	...
	/* (non-Javadoc)
	 * @see com.android.extendedWidgets.OnProgressChangedListener#makeAction(int)
	 */
	@Override
